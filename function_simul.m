...
function [foundIdx,foundMISS] = function_simul(N,choiceH,choiceUpdS,MaxHideTrials,theta)
...
fprintf('\nHow would you update S (1: no update, 2: uniform update, 3: structural update): %d',choiceUpdS);
